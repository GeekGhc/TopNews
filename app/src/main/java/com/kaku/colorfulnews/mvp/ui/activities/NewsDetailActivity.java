...
//        mProgressBar.setVisibility(View.GONE);
    ...
    private void share()
    {
        ...
        oks.setTitle(this.mNewsTitle);
        // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
        oks.setTitleUrl("https://github.com/GeekGhc/TopNews");
        // text是分享文本，所有平台都需要这个字段
        oks.setText(newsSource);
        //分享网络图片，新浪微博分享网络图片需要通过审核后申请高级写入接口，否则请注释掉测试新浪微博
        oks.setImageUrl(NewsImgSrc);
        ...
        oks.setSiteUrl("https://github.com/GeekGhc/TopNews");
